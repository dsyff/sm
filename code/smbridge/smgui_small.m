...
if nargin > 0
   ...
   smaux.smgui.FileMenu = uimenu('Parent',smaux.smgui.figure1,...
    ...
    dataH = smguiLeftPanelHeight(3, layoutMetrics);
    pptH = smguiLeftPanelHeight(2, layoutMetrics);
    ...
    smaux.smgui.datapanel = uipanel('Parent',smaux.smgui.nullpanel,'Title','Data File',...
        ...
        smaux.smgui.savedata_pbh = uicontrol('Parent',smaux.smgui.datapanel,'Style','pushbutton',...
            'String','Path',...
            'Position',[4 smguiLeftPanelRowY(dataH, 1, layoutMetrics) 50 layoutMetrics.ctrlH],...
            'Callback',@SavePath);
        smaux.smgui.datapath_sth = uicontrol('Parent',smaux.smgui.datapanel,'Style','text',...
            ...
            'FontSize',8,...
            'Max',50,...
            'Position',[58 smguiLeftPanelRowY(dataH, 1, layoutMetrics)+rowTextYOffset leftW-64 layoutMetrics.ctrlH]);
        smaux.smgui.filename_pbh = uicontrol('Parent',smaux.smgui.datapanel,'Style','pushbutton',...
            ...
            'Position',[4 smguiLeftPanelRowY(dataH, 2, layoutMetrics) 50 layoutMetrics.ctrlH],...
            'Callback',@FileName);
        smaux.smgui.filename_eth = uicontrol('Parent',smaux.smgui.datapanel,'Style','edit',...
            'String','',...
            'HorizontalAlignment','left',...
            'FontSize',8,...
            'Position',[58 smguiLeftPanelRowY(dataH, 2, layoutMetrics) leftW-64 layoutMetrics.ctrlH]);
        smaux.smgui.runnumber_sth = uicontrol('Parent',smaux.smgui.datapanel,'Style','text',...
            'String','Run:',...
            'HorizontalAlignment','right',...
            'FontSize',8,...
            'Position',[4 smguiLeftPanelRowY(dataH, 3, layoutMetrics)+rowTextYOffset 30 layoutMetrics.ctrlH]);
        smaux.smgui.runnumber_eth = uicontrol('Parent',smaux.smgui.datapanel,'Style','edit',...
            'String','',...
            'HorizontalAlignment','left',...
            'FontSize',8,...
            'Position',[38 smguiLeftPanelRowY(dataH, 3, layoutMetrics) 35 layoutMetrics.ctrlH],...
            'Callback',@RunNumber);
        ...
        smaux.smgui.autoincrement_cbh = uicontrol('Parent',smaux.smgui.datapanel,'Style','checkbox',...
            ...
            'Position',[80 smguiLeftPanelRowY(dataH, 3, layoutMetrics) leftW-86 layoutMetrics.ctrlH],...
            'Value',1);
    ...
    smaux.smgui.pptpanel = uipanel('Parent',smaux.smgui.nullpanel,'Title','PowerPoint Log',...
        ...
        smaux.smgui.saveppt_pbh = uicontrol('Parent',smaux.smgui.pptpanel,'Style','pushbutton',...
            'String','File',...
            'Position',[4 smguiLeftPanelRowY(pptH, 1, layoutMetrics) 60 layoutMetrics.ctrlH],...
            'FontSize',8,...
            'Callback',@SavePPT);
        smaux.smgui.pptfile_sth = uicontrol('Parent',smaux.smgui.pptpanel,'Style','text',...
            ...
            'HorizontalAlignment','center',...
            'FontSize',7,...
            'Position',[2 smguiLeftPanelRowY(pptH, 2, layoutMetrics)+rowTextYOffset leftW-6 layoutMetrics.ctrlH]);
        smaux.smgui.appendppt_cbh = uicontrol('Parent',smaux.smgui.pptpanel,'Style','checkbox',...
            'String','Log',...
            'Position',[leftW-78 smguiLeftPanelRowY(pptH, 1, layoutMetrics) 70 layoutMetrics.ctrlH],...
            'HorizontalAlignment','left',...
            'FontSize',8,...
            'Value',1,...
