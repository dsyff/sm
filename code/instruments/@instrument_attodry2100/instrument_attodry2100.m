classdef instrument_attodry2100 < instrumentInterface
    ...
    methods (Access = ?instrumentInterface)
        function getWriteChannelHelper(obj, channelIndex)
            magnetChannel = 0; % Thomas: Attodry2100 has a single magnet channel (always 0)
            switch channelIndex
                case 1
                ...
                case 2
                    [errorNumber, rawField] = magnet_getH(obj.communicationHandle, magnetChannel);
                    obj.assertNoError(errorNumber, "magnet_getH");
                    obj.lastField = double(rawField);
                case 3
                    [errorNumber, drivenMode] = magnet_getDrivenMode(obj.communicationHandle, magnetChannel);
        ...
        function setWriteChannelHelper(obj, channelIndex, setValues)
            ...
            switch channelIndex
                ...
                case 2
                    errorNumber = magnet_setHSetPoint(handle, magnetChannel, setValues);
                    obj.assertNoError(errorNumber, "magnet_setHSetPoint");
                    errorNumber = magnet_startFieldControl(handle, magnetChannel);
                ...
                case 3
                    ...
                    errorNumber = magnet_setDrivenMode(handle, magnetChannel, drivenMode);
