...
overloadTolerance = 7.5E-10; %m tolerance for progress detection. allows a small progress (decrease) in del_d_diff to still be counted as stalling. set to larger than noise level
